...
reference_train@meta.data$ag_specificity <- factor(reference_train@meta.data$ag_specificity, levels = c("specific", "nonspecific") )
reference_test@meta.data$ag_specificity <- factor(reference_test@meta.data$ag_specificity, levels = c("specific", "nonspecific") )
